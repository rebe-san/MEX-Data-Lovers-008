...
const captureInput = () => {
   ...
   //Guarda el valor de la variable stringt
    console.log("string introducido"+inputName);
    let arrayPokemon=filterName(inputName);
    console.log("arrayPokemon");
    console.log(arrayPokemon);
    arrayPokemon.forEach(showData = (objPokemon) => {
    ...
    // document.getElementById("input-name").value = ''; //Borra el contenido de la caja de texto
});
  }
